        ...
        subItems: [
          {
            ...
            label: "New",
            subItems: [
              { path: "/admin/NewEstimate", label: "Estimate" },
    ...
    <div>
      ...
      >
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            <span
              className="flex flex-col items-center gap-2" // stack vertically
              style={{ textAlign: "center" }}
            >
              <img
                src={ceb}
                alt="CEB Logo"
                style={{ marginBottom: "8px", height : "50px", width : "50PX" }} // add spacing below logo
              />
              <h3
                style={{
                  color: "#b33333", // CEB red color
                  fontWeight: "bold",
                  fontSize: "1rem", // Larger SPS text
                }}
              >
